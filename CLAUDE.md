...
This project is indexed by GitNexus as **cove** (186 symbols, 336 relationships, 11 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
