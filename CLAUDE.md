...
This project is indexed by GitNexus as **boxify-api-go** (7811 symbols, 30848 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
