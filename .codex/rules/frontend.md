...
- Treat iOS as the primary mobile platform. Every App scenario must begin by loading and following `.agents/skills/ios-simulator/SKILL.md`; use its repository-discovery, build, lifecycle, layered-diagnosis, Computer Use interaction, and evidence workflow instead of inventing per-task Simulator commands.
